# Explicit experiment deploy

Ruined Gate Terrarium pre-Owner agent-rehearsal build. Deployment exists for browser/runtime inspection only; it is not Owner-qualified.
